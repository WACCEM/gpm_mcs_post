...
base_name=(
    "e5.csf." "e5.oper.an.vinteg.162_084_viwvd.ll025sc."
    "e5.oper.an.sfc.128_137_tcwv.ll025sc."  "e5.oper.an.sfc.128_059_cape.ll025sc." 
...
#       "vinteg")
# regions=("4scream")
code_name="/global/homes/f/feng045/program/gpm_mcs_post/extract_mcs_era5_2d_fullhistory.py"
...
for region in "${regions[@]}"; do
    ...
    for ((i = 0; i < ${#base_name[@]}; ++i)); do
        ...
        for year in $(seq ${start_year} ${end_year}); do  
            ...
            # date="${year}0101.0000_${year}1231.0000"
