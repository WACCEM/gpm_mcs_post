"""
Extracts ERA5 static 2D variable centered at each MCS saves the output to a netCDF file.
"""
__author__ = "Zhe.Feng@pnnl.gov"
__date__ = "3-June-2022"
...
if __name__ == "__main__":
    ...
    era5_dir = config['era5_dir_static'] + dirname + "/"
    ...
    # Static ERA5 file name
    era5_file = f'{era5_dir}{basename}1979010100_1979010100.nc'
    if os.path.isfile(era5_file) == False:
        print(f'ERROR: ERA5 not found: {era5_file}')
    ...
    gattr_dict = {
        'Title': 'ERA5 extracted 2D static data for MCS',
        'lon_box_size': nx*2+1,
        'lat_box_size': ny*2+1,
