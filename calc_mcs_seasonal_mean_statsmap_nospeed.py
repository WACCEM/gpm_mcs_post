...
datadir = f'/global/cscratch1/sd/feng045/waccem/mcs_region/{region}/stats_pfmaxis/monthly/'
pcpdir = datadir
...
mcs_pfdiam_avg_month = np.sqrt(mcs_pfarea_avg_month / np.pi)
...
mcs_pfdiam_avg_season = np.sqrt(mcs_pfarea_avg_season / np.pi)
...
#                          'mcs_freq_ccs':{'zlib':True, '_FillValue':fillvalue, 'dtype':'float32'}, \
#                          'mcs_freq_pf':{'zlib':True, '_FillValue':fillvalue, 'dtype':'float32'}, \
#                          'mcs_initiation_ccs':{'zlib':True, '_FillValue':fillvalue, 'dtype':'float32'}, \
#                          'mcs_pfarea':{'zlib':True, '_FillValue':fillvalue, 'dtype':'float32'}, \
#                          'mcs_pfdiameter':{'zlib':True, '_FillValue':fillvalue, 'dtype':'float32'}, \
#                          'mcs_speed':{'zlib':True, '_FillValue':fillvalue, 'dtype':'float32'}, \
#                          'mcs_uspeed':{'zlib':True, '_FillValue':fillvalue, 'dtype':'float32'}, \
#                          'mcs_vspeed':{'zlib':True, '_FillValue':fillvalue, 'dtype':'float32'}, \
#                          })
