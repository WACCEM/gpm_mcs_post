...
speed = stats.movement_r_meters_per_second.sel(tracks=trackidx)
# movement_x and movement_y are in [km]/timestep, divide by 3.6 (1000m/3600s) to convert to [m/s]
uspeed = stats.movement_storm_x.sel(tracks=trackidx)/3.6
vspeed = stats.movement_storm_y.sel(tracks=trackidx)/3.6
